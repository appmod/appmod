<?php
require_once '/var/www/db_files/adv_config.php';
...
class DB_Functions_GCM {
	...
	public function getAllUsers() {
		$result = mysqli_query($GLOBALS['mysqli_connection'], "select * FROM gcm_users where role='Dependant' and status='paired' and withdraw='No' and complete='No'");
		return $result;
	}
	...
	public function getAllNotifications() {
		$result = mysqli_query($GLOBALS['mysqli_connection'], "select * FROM anomalyid");
		return $result;
	}
