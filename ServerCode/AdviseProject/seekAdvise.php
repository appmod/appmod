...
$insertsql = "insert into advices (anomalyid,seeker_phone,adviser,anomaly_desc,advice_asked_date) values('$anomalyid','$phoneNo','$adviserfetched','$anomaly',NOW())";
