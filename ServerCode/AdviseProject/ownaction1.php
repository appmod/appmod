...
$phoneNo=trim($intialArr[3]);
if (!empty($anomalyid)) {
  $conn = new mysqli(DB_HOST, DB_USER, DB_PASSWORD, DB_DATABASE);
  $updatesql = "update advices set advice_followed='no',own_action='$action',own_action_status='AfterReceivingAdvice',own_action_date=NOW() where anomalyid='$anomalyid'";
